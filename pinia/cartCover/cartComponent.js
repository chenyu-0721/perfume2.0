              ...
              <tbody>
                  ...
                  <tr v-for="(item) in perfume">
                    ...
                    <td>   
                        ...
                        <button @click="updateCardItem(item)" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">編輯   
                      </button>
                    </td>
                  </tr>
              </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" @click="handleButtonClick(getPerfumeData._id)" class="btn btn-primary" data-bs-dismiss="modal" >Save changes</button>
      </div>
    </div>
  </div>
</div>
